...
AFPSCharacter::AFPSCharacter()
{
	...
	NoiseEmitterComp = CreateDefaultSubobject<UPawnNoiseEmitterComponent>(TEXT("Noise Emiiier"));
}
...
void AFPSCharacter::Tick(float DeltaTime)
{
	...
	{
		// Fixes the issue where the client doesn't look up/down when viewed on the server.
...
void AFPSCharacter::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	// This conditional replication rule ensures that the variable is only replicated to the owning actor.
